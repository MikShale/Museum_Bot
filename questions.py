...
QUESTIONS = {
    "при развитии технической стороны общественной жизни духовная может очень сильно деградировать": {
        "Простой уровень": {
            "При каком царе произошла земская реформа?": ["при Иване Грозном", "при Михаиле Федоровиче", "при Петре Великом", "при Александре II"],
            "Что такое земство?": ["Приказы", "Министерства", "Органы местного самоуправления", "Собрания"],
            "Какой аналог этих органов существует в РФ сегодня?": ["Государственная Дума", "Органы местного самоуправления", "Правительство", "Государственный совет"]
        },
        "Средний уровень": {
    ...
    "Музей истории денег": {
        ...
        "Сложный уровень": {
            ...
            "в начале двадцатого века, в России усиливается эмиссия. Из-за этого простые люди использовали новые обесцененный бумажные рубли как топливо для буржуек. Что стало причиной усиления выпуска бумажных денег": ["политические процессы", "революция", "участие в войнах", "проведение реформ"],
        }
    }
}
